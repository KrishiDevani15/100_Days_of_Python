...
print("Welcome to Treasure Island.\n Your missin is to find the treasure.")
direction = input('You\'re at a cross road. Where do you want to go?\n Type "left" or "right"\n >> ').lower()

if direction == "left":
    print("")
    swim_wait = input('You\'re come at a lake. Where do you want to go?\n Type "wait" to wait for a boat. Type "swim" to swim across.\n >> ').lower()
    if swim_wait == "wait":
        print("")
        door = input('You arrive at rge island unharmed. There is a house with 3 doors.\n One red, One yellow and One blue. Which colour do you choose?\n >> ').lower()
        if door == "yellow":
